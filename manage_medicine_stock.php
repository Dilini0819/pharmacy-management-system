        ...
        <div class="row">
          ...
          <div class="col col-md-12 table-responsive">
            <div class="table-responsive">
                ...
                <!--manage_medicine_stock.php is included to load backend functions and data.-->
                <tbody id="medicines_stock_div">
                  <?php
                    require 'php/manage_medicine_stock.php';

                    //If URL has ?out_of_stock, it auto-filters to out-of-stock medicines.
                    if(isset($_GET['out_of_stock']))
                      echo "<script>searchMedicineStock('0', 'QUANTITY');</script>";

                    //If URL has ?expired, it filters to expired medicines.
                    else if(isset($_GET['expired']))
                      echo "<script>searchMedicineStock('', 'EXPIRY_DATE');</script>";
                    else
                      showMedicinesStock("0"); //show all medicines (default call)
                  ?>
            		</tbody>
            	</table>
            </div>
